...
This page describes the manual setup approach used before reveal.js 6.0. If you're starting a new project, use the official [**@revealjs/react**](/react/) package instead.
