...
<tbody>
<tr>
<td style="text-align: left;">data-auto-animate-easing</td>
<td style="text-align: right;">ease</td>
<td style="text-align: left;">A CSS <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/easing-function">easing function</a>.</td>
</tr>
<tr>
<td style="text-align: left;">data-auto-animate-unmatched</td>
<td style="text-align: right;">true</td>
<td style="text-align: left;">Determines whether elements with no matching auto-animate target should fade in. Set to false to make them appear instantly.</td>
</tr>
<tr>
<td style="text-align: left;">data-auto-animate-duration</td>
<td style="text-align: right;">1.0</td>
<td style="text-align: left;">Animation duration in seconds.</td>
</tr>
<tr>
<td style="text-align: left;">data-auto-animate-delay</td>
<td style="text-align: right;">0</td>
<td style="text-align: left;">Animation delay in seconds (can only be set for specific elements, not at the slide level).</td>
</tr>
<tr>
<td style="text-align: left;">data-auto-animate-id</td>
<td style="text-align: right;"><em>absent</em></td>
<td style="text-align: left;">An <a href="#auto-animate-id-%26-restart">id</a> tying auto-animate slides together.</td>
</tr>
<tr>
<td style="text-align: left;">data-auto-animate-restart</td>
<td style="text-align: right;"><em>absent</em></td>
<td style="text-align: left;"><a href="#auto-animate-id-%26-restart">Breaks apart</a> two adjacent auto-animate slides (even with the same id).</td>
</tr>
</tbody>
</table>
